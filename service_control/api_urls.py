...
from .api_views import (
    ...
    ServiceOrderAddPaymentAPIView,
    ServiceOrderAttendantMetricsAPIView,
    ServiceOrderChangePhaseAPIView,
...
urlpatterns = [
    ...
    path(
        "service-orders/<int:order_id>/refund/",
        ServiceOrderRefundAPIView.as_view(),
        name="api_service_order_refund",
    ),
    path(
    ...
    path(
        ...
        ServiceOrderChangePhaseAPIView.as_view(),
        name="api_service_order_change_phase",
    ),
    path(
